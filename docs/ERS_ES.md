...
*   [Especificación de Requisitos de Software (ERS)](./ERS_ES.md) — este documento.
*   [Plan de Pruebas](./test-plan.md) — Escenarios de prueba (happy path y edge cases) por funcionalidad.
...
Durante la implementación, la docente indicó dos ajustes de alcance respecto al diseño original documentado en este ERS:
